//$(document).ready(function () {
    document.addEventListener('DOMContentLoaded', function() {
        ...
        //var VueFooterNav= new Vue({
            ...
            data: {
                ...
                menuItems: [
                  { subItems: [], Name: 'Our Services', link: 'https://www.stchristophershospital.com/SitePages/Our-Services.aspx' },
                  { subItems: [], Name: 'Our Locations', link: 'https://www.stchristophershospital.com/SitePages/Our-Locations.aspx' },
                  { subItems: [], Name: 'Our Stories', link: 'https://www.stchristophershospital.com/SitePages/Our-Stories.aspx' },
                  { subItems: [], Name: 'For Patients', link: 'https://www.stchristophershospital.com/SitePages/For-Patients.aspx' },
                  { subItems: [], Name: 'For Family & Visitors', link: 'https://www.stchristophershospital.com/SitePages/For-Family-and-Visitors.aspx' },
                  { subItems: [], Name: 'For Health Professionals', link: 'https://www.stchristophershospital.com/SitePages/For-Health-Professionals.aspx' }
                ]
    ...
    //                var relativeFolderPath = relativePath.substring(0, relativePath.lastIndexOf("/"));
                    var relativeFolderPath = "https://www.stchristophershospital.com/SitePages/";
    ...
    //                var getFilesURL = _spPageContextInfo.siteAbsoluteUrl+ "/_api/Web/GetFolderByServerRelativeUrl('{path}')?$expand=Files,Folders/Files";
                    var getFilesURL = "https://www.stchristophershospital.com/_api/Web/GetFolderByServerRelativeUrl('{path}')?$expand=Files,Folders/Files";
                    ...
                    VueTopNav.addMainMenuPagesAndSubpages(menuJSON);
    /*
    ...
    //                        var pageURL = _spPageContextInfo.siteAbsoluteUrl + '/SitePages/' + menuItem.Name + '.aspx';
                    var pageURL = 'https://www.stchristophershospital.com/SitePages/' + menuItem.Name + '.aspx';
    ...
    //    VueFooterNav.buildMainMenu();
        ...
        //Add Search funtionality for the Search button click event
        $('#sharePointSearch').click( function(e) {
            e.preventDefault();
            var searchParameter = $( "#sharePointSearchParameter").val();
            window.location = "https://www.stchristophershospital.com/_layouts/15/osssearchresults.aspx?k=" + searchParameter;
            return false; } );
    });  //$(document).ready(function()
